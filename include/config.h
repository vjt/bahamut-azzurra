...
#define IRCDSSL_CPATH "ircd.crt" /*SSL - AZZURRA*/
#define IRCDSSL_KPATH "ircd.key" /*SSL - AZZURRA*/
 ...
 */
#undef DEFAULT_HELP_MODE /* azzurra --vjt 06/05/2k+2 */
...
/*
 * ANTI_INVITE_FLOOD - prevents invite flooding define if you want to block
 * local clients from inviteflooding
 */
#define ANTI_INVITE_FLOOD

/*
 * defaults allow 3 invites in 30 seconds 
 */
#define MAX_INVITE_TIME 30
...
/* --------------------- AZZURRA CONFIGURATION SECTION -------------------- */

/* SHUN
 * Enable or disable the /shun command . . . please leave this enabled
 * for Azzurra servers . . . . if you don`t know what it does, go nuts.
 */
#define SHUN
 ...
 * Default: "ircd.cloak"
 */
#define CKPATH			"ircd.cloak"

/* CLOAK_HOST
 * String used for cloacked hosts
 * Default: "Azzurra" on Azzurra IRC Network
 */
#define CLOAK_HOST		"Azzurra"

/* NETWORK_NAME
 * String used to identify the network.
 * Default: CLOAK_HOST
 */
#define NETWORK_NAME		CLOAK_HOST

/* SECURITY_CHANNEL: channel used for security notices
 * OPERATORS_CHANNEL: public channel used by IRC operators
...
/* NO_DEFAULT_UMODEX
 * Define this to disable automaticuser  cloacking.
 */
#undef NO_DEFAULT_UMODEX

/* NO_SERVER_IDENTD
 * Stop identd checks on servers to speed up server connections.
 */
#define NO_SERVER_IDENTD

/* NO_LOCAL_IDENTD
 * Define this if you have problem with bad characters in
 * local identd (usually a Solaris problem).
 */
#define NO_LOCAL_IDENTD
 ...
 * and you don't want to enable SYSLOG.
 * Activities currently logged:
 * - USERS CONNECTIONS
 * - USERS QUITS
 */
#define USE_ACTIVITY_LOG

#ifdef USE_ACTIVITY_LOG
/* ACTIVITY_LOG_FILE
 * Full path and name of the file used by activity logger.
 ...
 * SHOW_RESTRICTED_JOINS: enabled security notification. (default: undef)
